...
class OperationService {
     ...
     * @return - { tasks: Task[] }
     */
    ServiceResponse get_all_tasks(const nlohmann::json& payload,
     ...
     * @return - {}
     */
    ServiceResponse create_task(const nlohmann::json& payload,
                                const std::string& username) const;
     ...
     * @return - {}
     */
    ServiceResponse remove_task(const nlohmann::json& payload,
                                const std::string& username) const;
    ...
    * @return status
    */
    ServiceResponse create_task_list(const nlohmann::json& payload,
                                     const std::string& username) const;
     ...
     * @return status
     */
    ServiceResponse join_task_list(const nlohmann::json& payload,
                                   const std::string& username) const;
...
public:
    ...
    ServiceResponse service_gateway(ResourceMethod resource_method,
